...
This roadmap shows the public direction for Gilbert Codex after the v0.8.0 alpha. It is product-facing by design: contributors should be able to see what is upcoming, why it matters, and where their work can help.
...
v0.8.0 makes the main chat workspace, subscription setup, and cross-platform release path feel more dependable. Gmail, Google Calendar, plugins, tasks, voice, model routes, workspace tools, and MCP-facing surfaces now have stronger app-owned management paths; the remaining work is turning the rest of the catalog into a polished hub.
...
The main v0.8.0 foundation is making app-owned runtime behavior boringly reliable across providers, subscription routes, permission modes, full-computer workspace access, real repositories, and desktop release targets.
