...
- SHA-256: `2602ade37ccb0e578e01ecde2e58e1d09e6575231a03a52bb01eab4249c5f5dc`
...
- App update checks now show a clear "No update feed" state when no signed `latest.json` feed has been published yet.
...
- Signed updater artifacts require the `TAURI_SIGNING_PRIVATE_KEY` GitHub Actions secret; if that secret is unavailable, this release ships as a manual installer/checksum release until the updater feed is published.
