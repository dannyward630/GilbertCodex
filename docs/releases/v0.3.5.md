...
Gilbert Codex v0.3.5 is a public alpha update focused on a cleaner local desktop runtime, refreshed contributor-facing documentation, and a safer open-source release posture.
