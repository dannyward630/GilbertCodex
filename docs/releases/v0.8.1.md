...
- Updated CI and release workflow runners for steadier builds: Windows targets `windows-2025-vs2026`, macOS is pinned to `macos-15`, and Node setup uses Node 24.
