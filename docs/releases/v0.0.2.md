...
Gilbert Codex v0.0.2 is the second public Windows alpha. It focuses on making the project more useful as a public desktop agent workspace: a SQL-backed local database, stronger local Git review surfaces, broader GitHub tooling, app-update plumbing, and contributor-ready repository structure.
