export function describeCodingTools() {
  return [
    "Coding tools: delete_file, check_duplicate_file, prevent_duplicate_file_create, create_chat_pdf, inline_edit, vector_embed_text, vector_search, run_tests, typescript_check, create_sql_schema, create_sql_migration, create_react_native_screen, react_native_setup_check, create_unit_test, codebase_health_scan, dependency_audit, create_api_route.",
    "delete_file removes one file only, never folders, and requires confirm_delete=true plus write permission.",
