...
export const PLUGIN_LISTINGS: PluginListing[] = [
  ...
  listing({
    ...
    description: "First-party GitHub plugin for local Git, repositories, completed-issue discovery, issue lifecycle, pull request reviews, releases, Actions jobs/artifacts, security alerts, notifications, stats, tags, and REST API access.",
    id: "github",
    installCount: 240296,
    name: "GitHub",
    permissions: [repoRead, repoWrite],
    publisher: "Gilbert Codex",
    skills: [skill("github", "GitHub workflow", "Use repository, pull request, completed issue, issue lifecycle, Actions, release, code-search, security, notifications, and local Git context.", "Apps & data", ["GitHub", "PR", "Issues", "Actions"])],
    tags: ["Repositories", "Pull requests", "Issues", "Actions", "Security"],
    trust: "Verified",
  }),
  listing({
    category: "Testing",
