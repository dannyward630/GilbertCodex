...
- Local capability families for diagnostics, file reads/search/listing, editing, terminal execution, browser preview, local Git, GitHub API surfaces, web search, and MCP-facing discovery/calls where settings and permissions allow them.
...
- Apps page reset to a clear coming-next state for Plugins, Apps, Skills, and more.
...
- The Apps / Plugins / Skills page is the next major missing product surface.
...
- Build the full Apps / Plugins / Skills surface instead of leaving it as a placeholder.
